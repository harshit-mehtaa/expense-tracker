...
router.post('/profile', asyncHandler(async (req, res) => {
  ...
  const data = z.object({
    ...
    hraReceived: z.number().nullable().optional(),
    rentPaidMonthly: z.number().nullable().optional(),
    cityType: z.enum(['METRO', 'NON_METRO']).nullable().optional(),
    deduction80C: z.number().nullable().optional(),
    deduction80D: z.number().nullable().optional(),
    deduction80E: z.number().nullable().optional(),
    deduction80G: z.number().nullable().optional(),
    deduction24B: z.number().nullable().optional(),
    nps80Ccd1B: z.number().nullable().optional(),
    otherDeductions: z.number().nullable().optional(),
    taxPaidAdvance: z.number().nullable().optional(),
    taxPaidTds: z.number().nullable().optional(),
    taxPaidSelfAssessment: z.number().nullable().optional(),
  }).parse(req.body);
